...
import PendingFieldset from "@/app/(app)/generate/_components/pending-fieldset"
import SubmitButton from "@/app/(app)/generate/_components/submit-button"
...
export default function TakeQuizForm({
  ...
  const normalized = useMemo<Array<SelectQuestion & { opts?: string[] }>>(
    () =>
      questions.map(q => ({
        ...q,
      ...
      <PendingFieldset>
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="text-muted-foreground text-xs">
            Submitting and grading may take a few seconds.
          </div>
